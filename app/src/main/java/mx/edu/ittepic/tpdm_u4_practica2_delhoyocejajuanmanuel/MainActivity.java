package mx.edu.ittepic.tpdm_u4_practica2_delhoyocejajuanmanuel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void casillaSeleccionada(int renglon, int columna, View objeto){
        if (esElTurnoDelJugador) {
            if (tablero[renglon][columna] == 0) {
                ...
                a.setImageResource(R.drawable.cruz);
    ...
    private void reiniciar () {
        ...
        casilla00.setImageResource(R.drawable.vacio);
        casilla01.setImageResource(R.drawable.vacio);
        casilla02.setImageResource(R.drawable.vacio);
        casilla10.setImageResource(R.drawable.vacio);
        casilla11.setImageResource(R.drawable.vacio);
        casilla12.setImageResource(R.drawable.vacio);
        casilla20.setImageResource(R.drawable.vacio);
        casilla21.setImageResource(R.drawable.vacio);
        casilla22.setImageResource(R.drawable.vacio);
        ganador.setText("");
    }
